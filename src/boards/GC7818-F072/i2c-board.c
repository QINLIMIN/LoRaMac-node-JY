...
void I2cMcuResetBus( I2c_t *obj )
{
    ...
    GpioInit( &obj->Scl, I2C_SCL, PIN_ALTERNATE_FCT, PIN_OPEN_DRAIN, PIN_PULL_UP, GPIO_AF1_I2C1 );
    GpioInit( &obj->Sda, I2C_SDA, PIN_ALTERNATE_FCT, PIN_OPEN_DRAIN, PIN_PULL_UP, GPIO_AF1_I2C1 );
