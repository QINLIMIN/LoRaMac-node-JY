...
#define RADIO_NSS                                   PB_12  //PB_6

#define RADIO_DIO_0                                 PB_3   //PA_10
#define RADIO_DIO_1                                 PA_12  //PB_3
#define RADIO_DIO_2                                 PA_11  //PB_5
#define RADIO_DIO_3                                 PA_8   //PB_4
#define RADIO_DIO_4                                 NC     //PA_9
#define RADIO_DIO_5                                 NC     //PC_7

#define RADIO_ANT_SWITCH                            NC     //PC_1

#define LED_1                                       PB_4//NC
#define LED_2                                       PB_5//NC
#define LED_GREEN                                   PB_4
#define LED_RED                                     PB_5
#define LED_ON_BOARD                                PB_2
...
#define RS485EN_PWM                                 PB_8
#define RELAY_CTR                                   PB_9
#define HLW8012_SEL                                 PA_4
#define HLW8012_CF1                                 PA_5
#define HLW8012_CF                                  PA_6
#define ZCD                                         PA_7
#define S0_10V_PWM                                  PB_11
#define AN0_FB                                      PA_0
#define AN1_TEMP                                    PA_1
#define HAND_REPAIR_TRIG                            PB_0
